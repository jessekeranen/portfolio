 ...
 * @version 2020.10.08 14:22:21 // Generated by ComTest
 *
 */
...
public class PortfolioTest {
  ...
  // Generated by ComTest BEGIN  // Portfolio: 11
  ...
  /** testAddCompany121 */
  @Test
  public void testAddCompany121() {    // Portfolio: 121
    exampleCompanies(); 
    int count = portfolio.companies.size(); 
    assertEquals("From: Portfolio line: 124", 3, count); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** 
   * testPortfolioReturn135 
   * @throws Exception when error
   */
  @Test
  public void testPortfolioReturn135() throws Exception {    // Portfolio: 135
    exampleCompanies(); 
    ...
    assertEquals("From: Portfolio line: 148", "[0.0, 0.88, 0.41, 0.25, 0.16, 0.11, 0.07, 0.04, 0.02, -0.0, -0.02, -0.03]", Arrays.toString(array)); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** 
   * testPortfolioMarketValue185 
   * @throws Exception when error
   */
  @Test
  public void testPortfolioMarketValue185() throws Exception {    // Portfolio: 185
    exampleCompanies(); 
    ...
    assertEquals("From: Portfolio line: 199", "[5175.0, 9750.0, 13725.0, 17100.0, 19875.0, 22050.0, 23625.0, 24600.0, 24975.0, 24750.0, 23925.0, 22500.0]", Arrays.toString(array)); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** testPortfolioBeMe215 */
  @Test
  public void testPortfolioBeMe215() {    // Portfolio: 215
    exampleCompanies(); 
    ...
    assertEquals("From: Portfolio line: 231", "[0.74, 0.53, 0.48, 0.47, 0.48, 0.51, 0.56, 0.63, 0.75, 0.94, 1.38, 3.5]", Arrays.toString(array)); 
  } // Generated by ComTest END
  ...
  /** testGetMinValue247 */
  @Test
  public void testGetMinValue247() {    // Portfolio: 247
    exampleCompanies(); 
    assertEquals("From: Portfolio line: 250", -0.03, portfolio.getMinValue(), 0.01); 
  } // Generated by ComTest END
  ...
  /** testGetMaxValue264 */
  @Test
  public void testGetMaxValue264() {    // Portfolio: 264
    exampleCompanies(); 
    assertEquals("From: Portfolio line: 267", 0.88, portfolio.getMaxValue(), 0.01); 
  } // Generated by ComTest END
  ...
  /** testGetString301 */
  @Test
  public void testGetString301() {    // Portfolio: 301
    exampleCompanies(); 
    assertEquals("From: Portfolio line: 303", "0,17198", portfolio.getString(0)); 
    assertEquals("From: Portfolio line: 304", "19337,5", portfolio.getString(1)); 
    assertEquals("From: Portfolio line: 305", "0,9158", portfolio.getString(2)); 
  } // Generated by ComTest END
}