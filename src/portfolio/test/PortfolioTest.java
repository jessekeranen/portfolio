 ...
 * @version 2020.09.15 09:04:53 // Generated by ComTest
 *
 */
...
public class PortfolioTest {
  ...
  /** testAddCompany124 */
  @Test
  public void testAddCompany124() {    // Portfolio: 124
    exampleCompanies(); 
    int count = portfolio.companies.size(); 
    assertEquals("From: Portfolio line: 127", 3, count); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** 
   * testPortfolioReturn138 
   * @throws Exception when error
   */
  @Test
  public void testPortfolioReturn138() throws Exception {    // Portfolio: 138
    exampleCompanies(); 
    ...
    assertEquals("From: Portfolio line: 151", "[0.0, 0.88, 0.41, 0.25, 0.16, 0.11, 0.07, 0.04, 0.02, -0.0, -0.02, -0.03]", Arrays.toString(array)); 
  } // Generated by ComTest END
  ...
  /** testAverage180 */
  @Test
  public void testAverage180() {    // Portfolio: 180
    exampleCompanies(); 
    assertEquals("From: Portfolio line: 183", 0.012, portfolio.average(Nokia.returns), 0.001); 
    double[] array = new double[]{ 1.5, 0, -1.5, -1.6} ; 
    double[] array2 = new double[]{ } ; 
    double[] array3 = new double[]{ 1.6, 5.9, 99, 6.45, 1.88} ; 
    assertEquals("From: Portfolio line: 187", -0.4, portfolio.average(array), 0.001); 
    assertEquals("From: Portfolio line: 188", 0.0, portfolio.average(array2), 0.001); 
    assertEquals("From: Portfolio line: 189", 22.966, portfolio.average(array3), 0.001); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** 
   * testPortfolioMarketValue218 
   * @throws Exception when error
   */
  @Test
  public void testPortfolioMarketValue218() throws Exception {    // Portfolio: 218
    exampleCompanies(); 
    ...
    assertEquals("From: Portfolio line: 232", "[5175.0, 9750.0, 13725.0, 17100.0, 19875.0, 22050.0, 23625.0, 24600.0, 24975.0, 24750.0, 23925.0, 22500.0]", Arrays.toString(array)); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** testPortfolioBeMe248 */
  @Test
  public void testPortfolioBeMe248() {    // Portfolio: 248
    exampleCompanies(); 
    ...
    assertEquals("From: Portfolio line: 265", "[0.74, 0.53, 0.48, 0.47, 0.48, 0.51, 0.56, 0.63, 0.75, 0.94, 1.38, 3.5]", Arrays.toString(array)); 
  } // Generated by ComTest END
  ...
  /** testGetMinValue281 */
  @Test
  public void testGetMinValue281() {    // Portfolio: 281
    exampleCompanies(); 
    assertEquals("From: Portfolio line: 284", -0.03, portfolio.getMinValue(), 0.01); 
  } // Generated by ComTest END
  ...
  /** testGetMaxValue298 */
  @Test
  public void testGetMaxValue298() {    // Portfolio: 298
    exampleCompanies(); 
    assertEquals("From: Portfolio line: 301", 0.88, portfolio.getMaxValue(), 0.01); 
  } // Generated by ComTest END
}