 ...
 * @version 2020.09.14 08:27:15 // Generated by ComTest
 *
 */
...
public class CompanyTest {
   ...
   */
  @Test
  public void testBeMeRatio183() throws Exception {    // Company: 183
    exampleCompany(); 
    assertEquals("From: Company line: 190", "Nokia", Nokia.name); 
    assertEquals("From: Company line: 191", 12, Nokia.returns.length); 
    ...
    assertEquals("From: Company line: 198", "[1.54, 1.09, 0.94, 0.86, 0.82, 0.79, 0.76, 0.75, 0.73, 0.72, 0.72, 0.71]", Arrays.toString(array)); 
  } // Generated by ComTest END
}