 ...
 * @version 2020.09.28 12:21:47 // Generated by ComTest
 *
 */
...
public class CompanyTest {
   ...
   */
  @Test
  public void testReturns159() throws Exception {    // Company: 159
    exampleCompany(); 
    assertEquals("From: Company line: 166", "Nokia", Nokia.name); 
    assertEquals("From: Company line: 167", 12, Nokia.returns.length); 
    ...
    assertEquals("From: Company line: 174", "[0.0, 0.82, 0.35, 0.19, 0.09, 0.03, -0.03, -0.08, -0.15, -0.25, -0.44, -0.95]", Arrays.toString(array)); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testBeMeRatio189() throws Exception {    // Company: 189
    exampleCompany(); 
    assertEquals("From: Company line: 196", "Nokia", Nokia.name); 
    assertEquals("From: Company line: 197", 12, Nokia.returns.length); 
    ...
    assertEquals("From: Company line: 204", "[1.54, 1.09, 0.94, 0.86, 0.82, 0.79, 0.76, 0.75, 0.73, 0.72, 0.72, 0.71]", Arrays.toString(array)); 
  } // Generated by ComTest END
  ...
  /** testAverage308 */
  @Test
  public void testAverage308() {    // Company: 308
    exampleCompany(); 
    assertEquals("From: Company line: 311", 0.012, Nokia.average(Nokia.returns), 0.001); 
    double[] array = new double[]{ 1.5, 0, -1.5, -1.6} ; 
    double[] array2 = new double[]{ } ; 
    double[] array3 = new double[]{ 1.6, 5.9, 99, 6.45, 1.88} ; 
    assertEquals("From: Company line: 315", -0.4, Nokia.average(array), 0.001); 
    assertEquals("From: Company line: 316", 0.0, Nokia.average(array2), 0.001); 
    assertEquals("From: Company line: 317", 22.966, Nokia.average(array3), 0.001); 
  } // Generated by ComTest END
  ...
  /** testSharpeRatio336 */
  @Test
  public void testSharpeRatio336() {    // Company: 336
    exampleCompany(); 
    assertEquals("From: Company line: 339", -0.112799, Nokia.sharpeRatio, 0.000001); 
  } // Generated by ComTest END
}